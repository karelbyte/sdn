...
procedure Tfats.bimprimirClick(Sender: TObject);
begin
  inherited;
  ...
  findandremplace('<NOMBRE SUPERMERCADO>', supermercado.Text);

  footerdoc;
end;


procedure Tfats.rutautorizadoEnter(Sender: TObject);
begin
  inherited;
  rutenter_g(rutautorizado);
end;

procedure Tfats.rutautorizadoExit(Sender: TObject);
begin
  inherited;
  rutexit_g(rutautorizado, nameautorizado, nil);
end;

procedure Tfats.rutautorizadoKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  rutkeyp_g(rutautorizado, key);
end;

procedure Tfats.rutautorizanteEnter(Sender: TObject);
begin
  inherited;
  rutenter_g(rutautorizante);
end;

procedure Tfats.rutautorizanteExit(Sender: TObject);
begin
  inherited;
    rutexit_g(rutautorizante, nameautorizante, addressautorizante);
end;

procedure Tfats.rutautorizanteKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
